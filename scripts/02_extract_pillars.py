...
from _utils_ball import find_throw_and_arrival, slice_ball_window
...
def main():
    ...
    # Save canonical PER-10 / PER-10 360 traits
    ...
    # -------------------------------------------------------------------------
    # Legacy feature engineering for merged_pillars.csv (beta–binomial script)
    # -------------------------------------------------------------------------
    ...
    # Canonical Eyes for WRs, reusing the per10 Eyes_df (same metric)
